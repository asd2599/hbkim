...
게임 클라이언트 개발(약 3년)과 게임 프로그래밍 강사(약 9년)를 거쳐 AI 풀스택으로 전환했다. 오랜 개발·교육 경험에서 온 시스템 설계력·실시간 처리·전달력을 기반으로, AI 풀스택을 학습해 실제 동작하는 AI 제품을 빠르게 만드는 방향(바이브 코딩)으로 진로를 옮겼다.

## 경력 (Career)

- 2023.12 – 2025.12 · SBS게임아카데미 · 게임 프로그래밍 강사 — C/C++, DirectX, Unity 게임 프로그래밍 국비·국기 과정 강의.
- 2017.03 – 2023.12 · 서울게임아카데미 · 전임 강사(9년) — Unity, Unreal, C/C++ 게임 프로그래밍 국비·국기 과정 강의.
...
게임 프로그래밍 분야에서 약 10년간 강의했다(서울게임아카데미 전임 9년, SBS게임아카데미). 주요 과목은 C/C++, DirectX, Unity, Unreal 기반 게임 프로그래밍이며 국비·국기 과정을 담당했다. 비전공자·입문자에게 복잡한 개념을 쉽게 전달하는 데 강점이 있고, 이 전달력·문서화 역량은 AI 서비스 엔지니어로서도 핵심 자산이다.
