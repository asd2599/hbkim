    ...
    <aside className="sidebar">
      ...
      <div style={st.inner}>
        ...
        <div style={st.logoArea}>
          ...
          <span style={st.logoSub}>AI FDE Candidate</span>
        </div>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background:  isActive ? '#646cff18'  : 'transparent',
        ...
        <div style={st.socialArea}>
          ...
          <a href="mailto:asd25999@gmail.com" className="sidebar-social">
...
const st = {
  ...
  progressFill: {
    width: '100%',
    background: 'linear-gradient(180deg, #646cff, #a78bfa)',
